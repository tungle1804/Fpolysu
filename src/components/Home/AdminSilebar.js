      ...
      <div className="lg:w-64 h-screen">
        ...
        <div
          className={`fixed inset-0 bg-gray-900 bg-opacity-30 z-40 lg:hidden lg:z-auto transition-opacity duration-200 ${
            sidebarAdminOpen ? "opacity-50" : "opacity-0 pointer-events-none"
          }`}
          aria-hidden="true"
        ></div>
        ...
        <div
          id="sidebar"
          ref={sidebar}
          className={`absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 transform h-screen overflow-y-scroll  lg:overflow-y-auto no-scrollbar w-64 flex-shrink-0 bg-white pb-16 transition-transform duration-200 ease-in-out ${
            sidebarAdminOpen ? "translate-x-0" : "-translate-x-64"
          }`}
        >
          {/* Sidebar header */}
