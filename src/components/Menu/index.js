            ...
            <div className="flex-col border-r mt-16 pl-5 w-1/5 bg-gray-100 h-auto">
                ...
                <div className="overflow-auto" style={{ height: '430px' }}>
                    <div className="flex-col px-3">
                        <Link to='/admin'> <div className="items-center ml-2 py-4  mb-1 text-sm font-medium text-gray-700">    Tổng Quan</div>

                        </Link>
                        <Link to='/admin/list-menu' >       <div className="py-3 px-3 hover:bg-blue-100 cursor-pointer rounded text-sm text-gray-600  font-normal antialiased tracking-normal">
                            Quản lí Menu
          </div></Link>
                        <Link to='/admin/report'>                  <div className="py-3 px-3 hover:bg-blue-100 cursor-pointer rounded text-sm text-gray-600  font-normal antialiased tracking-normal">
                            Thông Kê
          </div></Link>
