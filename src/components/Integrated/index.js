                ...
                <div className="grid place-items-center w-4/5 mx-auto p-10 my-20 sm:my-auto bg-white-600 border-4 border-indigo-600 bg-opacity-70 rounded-xl shadow-2xl space-y-5 text-center cursor-pointer">
                    ...
                    <div className="p-2">
                        <div className="inline-flex items-center bg-white leading-none text-purple-600 rounded-full p-2 shadow text-teal text-sm">
                            ...
                            <span id='tichhop'
                                className="inline-flex px-2">&lt;script&gt;window.name="{localStorage.getItem("email")}"&lt;/script&gt;&lt;script src="index.js"&gt;&lt;/script&gt;
                            </span>
                        </div>
                    </div>
                    <p> Cách 2: Cài đặt plugin POLYSU. Đối với các Website sử dụng mã nguồn mở Wordpress, POLYSU cung cấp plugin để giúp dễ dàng tích hợp POLYSU lên Website của bạn.</p>
                </div>
            </div>
        </>
    )
