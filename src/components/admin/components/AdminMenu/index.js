      ...
      <div className="flex-col border-r mt-16 w-1/5 bg-gray-100 h-auto">
        ...
        <div className="overflow-auto" style={{ height: "530px" }}>
          <div className="flex-col py-3">
            ...
            <div className="">
              <div
                className="py-3 px-4 hover:bg-blue-100 cursor-pointer flex"
              ...
              >
                <Link
                  to="/admin/manage/statistical-customers"
                  style={{ textDecoration: "none" }}
                >
                  <div className="py-3 px-4 hover:bg-blue-100 cursor-pointer">
                ...
                <Link
                  to="/admin/manage/statistical-revenue"
                  style={{ textDecoration: "none" }}
                >
                  <div className="py-3 px-4 hover:bg-blue-100 cursor-pointer">
                    <span className="text-gray-900 pl-8">
