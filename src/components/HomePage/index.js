                    ...
                    <nav id="header" className="fixed bg-white shadow-xl text-white w-full  z-20 top-0">
                        ...
                        <div className="flex justify-between">
                            ...
                            <div className="w-full md:max-w-4xl bg-white flex-wrap items-center -mr-8 mt-0 my-auto">
                                ...
                                <div className="flex">
                                    <div className="w-full flex-grow  lg:flex lg:items-center lg:w-auto hidden lg:block  bg-white  z-20" id="nav-content">
                                        <ul className="list-reset lg:flex justify-center flex-1 gap-1 items-center my-auto">
                                            <li class="mr-2">
                                                <a class="inline-block lg:text-xl text-base py-2 px-2 text-black hover:text-purple-700 hover:bg-gray-300 rounded  transition duration-150 ease-in-out transform hover:scale-125"
                                            ...
                                            <div className="lg:flex hidden my-auto mr-2">
                                                ...
                                                <button onClick={() => history.push('/register')} className="flex-1 lg:h-16 h-10 text-xl py-2 w-40 px-3 mx-2 hover:text-white bg-red-500 rounded-full transition duration-150 ease-in-out transform hover:scale-110 bg-emerald-600 text-black font-semibold">
                                                    Đăng ký
                                                </button>
                                            </div>
