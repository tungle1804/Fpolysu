    ...
    <>
      ...
      <div className="bg-gray-100 font-montserrat">
        <header className="h-24 sm:h-32 flex items-center">
          ...
          <nav
            id="header"
            className="fixed bg-white shadow-xl text-white w-full  z-20 top-0"
          >
            <div
              id="progress"
            ...
            <div className="flex justify-between">
              <div className="flex font-black mb-3 lg:block hidden text-blue-900 text-5xl items-start ml-10">
                <span className="text-purple-700">Polysu</span>
                <div className="text-sm animate-pulse">
                  Tùy Biến Nút - Hút Khách Hàng
                </div>
              </div>
              <div className="w-full md:max-w-4xl bg-white flex-wrap items-center -mr-8 mt-0 my-auto">
                <div className="flex justify-between">
                  <div className="block lg:hidden ">
                    <div className="font-black text-blue-900 text-4xl flex items-start ml-2">
                      Polysu
                  ...
                  <div className="block lg:hidden pr-4">
                    <button
                      id="nav-toggle"
                      className="flex items-center px-3 py-2 text-black border-gray-600 focus:outline-none"
                    >
                      <svg
                        fill="text-black"
                        viewBox="0 0 20 20"
                ...
                <div className="flex">
                  <div
                    className="w-full flex-grow  lg:flex lg:items-center lg:w-auto hidden lg:block  bg-white  z-20"
                    id="nav-content"
                  >
                    <ul className="list-reset lg:flex justify-center flex-1 gap-1 items-center my-auto">
                      <li class="mr-2">
                        <a
                          class="inline-block lg:text-xl text-base py-2 px-2 text-black hover:text-purple-700 hover:bg-gray-300 rounded  transition duration-150 ease-in-out transform hover:scale-125"
                          href="#"
                      ...
                      <li class="mr-2">
                        <a
                          onClick={() => history.push("/hssd")}
                          class=" inline-block  lg:text-xl text-base text-black hover:text-purple-700 hover:bg-gray-300 rounded py-2 px-2 transition duration-150 ease-in-out transform hover:scale-125"
                          href="#"
                          style={{ textDecoration: "none" }}
                        >
                          Cách sử dụng
                      ...
                      <div className="lg:flex hidden my-auto mr-2">
                        ...
                        <button
                          ...
                          className="flex-1 lg:h-16 h-10 text-xl py-2 w-40 px-3 mx-2 hover:text-white bg-red-500 rounded-full transition duration-150 ease-in-out transform hover:scale-110 bg-emerald-600 text-black font-semibold"
                        >
                          Đăng ký
                        </button>
                      </div>
        ...
        <div className="container mx-auto px-6 sm:px-12 flex flex-col-reverse sm:flex-row relative">
          ...
          <div className=" sm:w-5/12 xl:w-4/12 flex flex-col items-start sm:items-end sm:text-right ml-auto mt-8 sm:mt-0 relative z-10 xl:pt-20 mb-16 sm:mb-0">
            ...
            <p className="lg:text-lg mb-4 sm:mb-12 text-blue-900">
              Công cụ tăng tỷ lệ tương tác với khách hàng trên website
            </p>
            <a
              href="#"
              className="font-semibold text-lg bg-purple-600 hover:bg-blue-400 text-white py-3 px-12 rounded-full transition duration-500 ease-in-out bg-blue-600 hover:bg-red-600 transform hover:-translate-y-1 hover:scale-110"
            >
              Thử ngay
            </a>
          </div>
        ...
        <div>
          ...
          <div className="min-w-screen min-h-screen bg-gray-50 flex items-center justify-center py-5">
            <div
              ...
              className="w-full bg-white bg-fixed border-t border-b border-gray-200 px-5 py-16 md:py-24 text-gray-800"
            >
              <div className="w-full max-w-6xl mx-auto">
                <div className="text-center max-w-xl mx-auto">
                  <h1 className="text-6xl md:text-7xl font-bold mb-5 text-black animate-pulse">
                    Mọi người <br />
                    Nói gì về Fpolysu.
                  </h1>
                  <h3 className="text-xl mb-5 font-medium">
                    Một tiện ích tuyệt vời.
                  </h3>
                    ...
                    <div className=" w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-10 transform hover:-translate-y-4 hover:scale-110 transition-transform duration-500 ease-in-out">
                      ...
                      <div className="w-full">
                        <p className="text-sm leading-tight">
                          ...
                          Quá tuyệt vời và thuận tiện cho website của tôi.
                    ...
                    <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-10 transform hover:-translate-y-4 hover:scale-110 transition-transform duration-500 ease-in-out">
                      ...
                      <div className="w-full">
                        <p className="text-sm leading-tight">
                          ...
                          Từ khi biết đến Polysu tương tác trên website tôi tăng
                          đáng kể.
                          <span className="text-lg leading-none italic font-bold text-gray-400 ml-1">
                            "
                          </span>
                    ...
                    <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-10 transform hover:-translate-y-4 hover:scale-110 transition-transform duration-500 ease-in-out">
                      ...
                      <div className="w-full">
                        <p className="text-sm leading-tight">
                          ...
                          Hoàn toàn hài lòng về công dụng của Polysu.
                          <span className="text-lg leading-none italic font-bold text-gray-400 ml-1">
                            "
                          </span>
                        </p>
                    ...
                    <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-10 transform hover:-translate-y-4 hover:scale-110 transition-transform duration-500 ease-in-out">
                      ...
                      <div className="w-full">
                        <p className="text-sm leading-tight">
                          ...
                          Từ khi biết đến Polysu khách hàng truy cập website của
                          chúng tôi cảm thấy rất thuận tiện!
                          <span className="text-lg leading-none italic font-bold text-gray-400 ml-1">
                            "
                          </span>
                        </p>
                    ...
                    <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-10 transform hover:-translate-y-4 hover:scale-110 transition-transform duration-500 ease-in-out">
                      ...
                      <div className="w-full">
                        <p className="text-sm leading-tight">
                          ...
                          Tùy chỉnh nút trên website rất dễ dàng giao diện dễ
                          nhìn, quá tốt!
                          <span className="text-lg leading-none italic font-bold text-gray-400 ml-1">
                            "
                          </span>
        ...
        <div className="text-gray-700 body-font flex md:flex-row flex-col items-center bg-white mx-20">
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center ">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
              Đăng ký nhận thông tin từ nhà phát triển
            </h1>
            ...
            <div className="flex flex-row justify-start w-full max-w-md shadow-xl border-t border-b border-gray-200">
              <input
                ...
                type="email"
              />
              <button className="inline-flex text-black py-2 px-6 focus:outline-none text-lg m-0 h-12 bg-gray-100 opacity-10 transform hover:opacity-100 hover:bg-purple-500 hover:scale-125  transition-opacity duration-500 ease-in-out">
                Gửi
              </button>
            </div>
            <p className="text-sm mt-2 text-gray-500 mb-8 w-full">
              Luôn đồng hành với chúng tôi.
            </p>
          ...
          <div className=" bg-purple-500 rounded-md transform skew-y-6 md:skew-2 shadow-2xl">
            <div className="mx-auto container pt-12 lg:pt-32 px-4 xl:px-12 2xl:px-4 py-5">
              <div className=" lg:pt-16 pt-6 pb-6 px-2 lg:px-0 lg:pb-12 border rounded-lg border-gray-200 dark:border-gray-700 flex flex-col items-center justify-center">
                <h2 className="text-[24px] md:text-3xl lg:text-6xl font-bold sm:font-black leading-tight tracking-tight text-center text-gray-900 dark:text-gray-50 w-11/12 lg:w-4/5">
                  Miễn phí trọn đời
                </h2>
                    ...
                    <div className="w-sm">
                      ...
                      <div className="mt-4 text-green-600 text-center">
                        ...
                        <p className="mt-4 text-gray-600">
                          Nhiều theme với nhiều tuỳ biến màu sắc khác nhau,
                          tương thích với mọi định dạng Website cả trên PC &
                          Mobile.
                        </p>
                  ...
                  <div className="mt-16 py-4 px-4 bg-whit w-72 bg-white rounded-xl shadow-lg hover:shadow-xl transform hover:scale-110 transition duration-500 mx-auto md:mx-0">
                    <div className="w-sm">
                      ...
                      <div className="mt-4 text-green-600 text-center">
                        ...
                        <p className="mt-4 text-gray-600">
                          Tăng tới 50% tỷ lệ chuyển đổi từ khách hàng. Đo đạc
                          hành vi trên trang của khách hàng, từ đó phân tích
                          thói quen mua hàng.{" "}
                        </p>
                        {/* <button className="mt-8 mb-4 py-2 px-14 rounded-full bg-green-600 text-white tracking-widest hover:bg-green-500 transition duration-200">MORE</button> */}
                      </div>
                  ...
                  <div className="mt-16 py-4 px-4 bg-whit w-72 bg-white rounded-xl shadow-lg hover:shadow-xl transform hover:scale-110 transition duration-500 mx-auto md:mx-0">
                    <div className="w-sm">
                      ...
                      <div className="mt-4 text-green-600 text-center">
                        ...
                        <p className="mt-4 text-gray-600">
                          Đồng bộ hoá dữ liệu khách hàng có được với các chiến
                          dịch quảng cáo, từ đó tối đa hoá hiệu quả dựa trên chi
                          phí bỏ ra.
                        </p>
                        {/* <button className="mt-8 mb-4 py-2 px-14 rounded-full bg-green-600 text-white tracking-widest hover:bg-green-500 transition duration-200">MORE</button> */}
                      </div>
        ...
        <div className="lg:px-20 pb-12">
          <h2 className="text-[24px] lg:text-6xl text-center font-bold sm:font-black leading-tight text-gray-900 dark:text-gray-50 ls-2 tracking-tight">
            Cập nhật thông tin mới nhất với Polysu
          </h2>
          <div className="mt-4 lg:mt-8 flex justify-center w-full">
            <p className="leading-7 w-full md:w-11/12 lg:w-9/12 text-center text-gray-600 dark:text-gray-400">
              Trải nghiệm của khách hàng luôn là ưu tiên hàng đầu.
            </p>
          </div>
          <div className="mt-24">
            <div className="flex flex-col flex-col-reverse md:flex-row items-center w-full justify-between bg-yellow-200 rounded-xl transform skew-y-3">
              <div className="md:pr-12 xl:pr-0 mt-8 md:mt-0 w-full md:w-7/12 text-center md:text-left">
                <h3 className="text-xl lg:text-4xl font-bold leading-9 text-gray-900 dark:text-gray-50 tracking-tight">
                  Dự kiến ngày ra mắt Polysu
                </h3>
                <p className="text-base lg:text-xl leading-7 text-gray-600 dark:text-gray-400 mt-4 w-full xl:w-10/12">
                  Thông tin ra mắt.
                </p>
                {/* <button className="mt-8 mb-4 py-2 px-14 rounded-full bg-green-600 text-white tracking-widest hover:bg-green-500 transition duration-200">MORE</button> */}
              </div>
              <img
                className=" animate-bounce w-144 h-144 sm:h-auto sm:w-1/2 lg:w-auto mx-auto md:mx-0 md:pl-6 xl:w-400"
                src="https://tailwinduikit.com/img/home/cross-browser.svg"
            ...
            <div className="mt-24 flex flex-col md:flex-row items-center w-full justify-between bg-purple-200 rounded-xl transform -skew-y-3">
              <img
                className="animate-bounce w-192 h-144 sm:h-auto sm:w-1/2 lg:w-auto mx-auto md:mx-0 md:pr-6 xl:w-400"
                src="https://tailwinduikit.com/img/home/tested.svg"
                alt="tailwind css components and templates"
              />
              <div className="w-full md:w-1/2 mt-8 md:mt-0 text-center md:text-left">
                <h3 className="text-xl lg:text-4xl font-bold leading-9 text-gray-900 dark:text-gray-50 tracking-tight">
                  Những tính năng nổi bật nhất mới ra mắt
                </h3>
                <p className="text-base lg:text-xl leading-7 text-gray-600 dark:text-gray-400 mt-4">
                  Thông tin tính năng.
                </p>
              </div>
            </div>
            <div className="flex flex-col flex-col-reverse md:flex-row items-center mt-24 w-full justify-between bg-red-200 rounded-xl transform skew-y-3">
              ...
              <img
                className="animate-bounce w-182 sm:w-1/2 lg:w-auto h-157 sm:h-auto mx-auto md:mx-0 md:pl-6 xl:w-400"
                src="https://tailwinduikit.com/img/home/accessibility.svg"
                alt="tailwind css components and templates"
              />
            </div>
            <div className="mt-24 flex flex-col md:flex-row items-center w-full justify-between bg-blue-200 rounded-xl transform -skew-y-3">
              <img
                className="animate-bounce w-187 sm:w-1/2 lg:w-auto h-187 sm:h-auto  mx-auto md:mx-0 md:pr-6 xl:w-400"
                src="https://tailwinduikit.com/img/home/responsive.svg"
                alt="tailwind css components and templates"
              />
              <div className="w-full md:w-1/2 mt-8 md:mt-0 text-center md:text-left">
                <h3 className="text-xl lg:text-4xl font-bold leading-9 text-gray-900 dark:text-gray-50 tracking-tight">
                  Những thành tựu Polysu
                </h3>
                <p className="text-base lg:text-xl leading-7 text-gray-600 dark:text-gray-400 mt-4">
                  Thông tin thành tựu.
                </p>
        ...
        <div className="px-10 py-6 shadow-xl ">
          <div className="mx-10 bg-purple-300 rounded-lg my-16 p-16 bg-indigo-400">
            <h1 className="text-3xl font-medium mb-2">
              Luôn mang lại cảm giác hài lòng nhất cho khách hàng
            </h1>
            <h2 className="font-medium text-lg text-indigo-400 mb-4 uppercase tracking-wide">
              Góp ý đến nhà phát triển
            </h2>
            ...
            <div className="bg-white shadow rounded-lg p-6 ">
              ...
              <textarea
                className="p-4 w-full border h-32 focus-within:border-blue-500 focus-within:text-blue-500"
                name=""
                id=""
                cols="30"
                rows="10"
        ...
        <div class="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
          ...
          <div class="grid justify-center pt-6 lg:justify-between">
            ...
            <div class="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
              <a
                href="#"
                class="flex items-center justify-center w-10 h-10 rounded-full bg-violet-600 text-coolGray-50"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
