...
const MenuByStatus_API_BASE_URL =
  "http://localhost:8080/api/v1/getMenuByStatus";
const UpdateStatus_Menu_API_BASE_URL =
  "http://localhost:8080/api/v1/updateStatusMenu";
class Menu {
  getMenu() {
  ...
  updateMenu(menu, idmenu) {
    return axios.put(UpdateStatus_Menu_API_BASE_URL + "/" + idmenu, menu);
  }
